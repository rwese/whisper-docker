...
def transcribe_audio_streaming(
    ...
    try:
        ...
        print(
            f"Detected language probability: {result['language_probability']:.2f}",
            file=sys.stderr,
        )
...
def transcribe_audio(
    audio_file, model_name="small", output_format="txt", output_dir=None, language=None
):
    """
  ...
  large   - ~2.9 GB, highest accuracy
    ...
    if args.format == "txt" and not args.output_dir:
        ...
        success = transcribe_audio(
            args.audio_file, args.model, args.format, args.output_dir, args.language
        )
