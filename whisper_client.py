...
class WhisperClient:
        ...
        if isinstance(audio_file, (str, Path)):
            ...
            with open(audio_file, "rb") as f:
                ...
                return self._do_transcribe(
                    files, model, language, output_format, streaming
                )
        else:
    ...
    def _do_transcribe(self, files, model, language, output_format, streaming):
        ...
        data = {"model": model, "output_format": output_format, "streaming": streaming}
    ...
    def transcribe_to_text(
        ...
        result = self.transcribe(
            audio_file, model=model, language=language, output_format="txt"
        )
    ...
    def transcribe_to_srt(
        ...
        return self.transcribe(
            audio_file, model=model, language=language, output_format="srt"
        )
    ...
    def transcribe_with_segments(
        ...
        """
        result = self.transcribe(
            audio_file, model=model, language=language, output_format="json"
        )
